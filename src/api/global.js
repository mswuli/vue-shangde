let SETING_ENV = "prod";
let REQUEST_URL = "https://sunlands.109km.com/education-beta/frontend/web/"; 
const weChatShare = "https://smallprogram.sunlands.com/wxapp-prod/frontend/web/index.php?r=spread/wechat"; 
const MBAH5_VERSION = '2.2.0'; 
